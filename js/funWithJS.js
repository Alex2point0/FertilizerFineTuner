...
ppmN = (document.getElementById('adjustCalNit').value*41) + (document.getElementById('adjustPotNit').value*36) + (document.getElementById('adjustAmmSul').value*56);
...
ppmS = (document.getElementById('adjustAmmSul').value*64) + (document.getElementById('adjustEpsom').value*33)
ppmFe = document.getElementById('adjustTrace').value*19.8;
document.getElementById('wrapper05').innerHTML = "Nitrogen: " + ppmN + "<br>Phosphorus: " + ppmP + "<br>Potassium: " + ppmK + "<br>Calcium: " + ppmCa + "<br>Magnesium: " + ppmMg + "<br>S: " + ppmS + "<br>Fe: " + ppmFe;
